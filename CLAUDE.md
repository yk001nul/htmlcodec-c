...
Every public function declaration and every `extern const` variable declaration in the 11 public headers is annotated with `HTMLCODEC_API`. All headers also wrap their declarations in `#ifdef __cplusplus extern "C" { #endif` guards for C++ / Python pybind11 consumers.
